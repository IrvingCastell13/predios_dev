        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="row align-items-end">
                    <div class="col-md-3">
                        <label class="form-label fw-bold">Filtro de Predios:</label>
                        <vue-multiselect v-model="prediosSeleccionados" :options="prediosDisponibles" :multiple="true" :close-on-select="false" placeholder="Todos" label="NombrePredio" track-by="IDPredio"></vue-multiselect>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-bold">Categoría (Grupo):</label>
                        <vue-multiselect v-model="gruposSeleccionados" :options="gruposDisponibles" :multiple="true" :close-on-select="false" placeholder="Todas" label="NombreGrupoDoc" track-by="IDGrupoDoc"></vue-multiselect>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-bold">Subcategoría:</label>
                        <vue-multiselect v-model="categoriasSeleccionadas" :options="categoriasDisponibles" :multiple="true" :close-on-select="false" :disabled="gruposSeleccionados.length === 0" placeholder="Seleccione categoría" label="NombreCategoriaDoc" track-by="IDCategoriaDoc"></vue-multiselect>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-bold">Tipo de Documento:</label>
                        <vue-multiselect v-model="tiposDocumentoSeleccionados" :options="tiposDocumentoDisponibles" :multiple="true" :close-on-select="false" placeholder="Todos" label="NombreTipoDocumento" track-by="IDTipoDocumento"></vue-multiselect>
                    </div>
                    <div class="col-md-3 mt-3">
                        <label class="form-label fw-bold">Tipo de Inmueble:</label>
                        <vue-multiselect v-model="tiposInmuebleSeleccionados" :options="tiposInmuebleDisponibles" :multiple="true" :close-on-select="false" placeholder="Todos" label="NombreTipoInmueble" track-by="IDTipoInmueble"></vue-multiselect>
                    </div>
                </div>
            </div>
        </div>
