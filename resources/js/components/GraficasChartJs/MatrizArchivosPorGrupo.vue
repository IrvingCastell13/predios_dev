    ...
    methods: {
        async fetchData() {
            ...
            try {
                ...
                this.chart = new ChartJS(ctx, {
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            tooltip: { callbacks: { label: ctx => ctx.raw.v === 100 ? 'Con archivo adjunto' : 'Sin archivo' } },
                ...
                console.error("Error cargando la matriz de archivos por grupo:", error);
            } finally {
