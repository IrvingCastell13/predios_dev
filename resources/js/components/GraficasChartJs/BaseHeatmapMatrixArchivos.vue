  ...
  <div style="height: 400px; position: relative; overflow-x: auto">
    ...
    >
      <span class="text-secondary"
        >Seleccione uno o más predios para ver los datos.</span
      >
    </div>
  </div>
</template>
...
export default {
  ...
  watch: {
    filtros: {
      ...
      deep: true, // Necesario para observar cambios dentro de un objeto
      immediate: true,
    },
  },
  methods: {
          ...
          options: {
            ...
            plugins: {
              ...
              tooltip: {
                callbacks: {
                  label: (ctx) =>
                    ctx.raw.v === 100 ? "Con archivo adjunto" : "Sin archivo",
                },
              },
