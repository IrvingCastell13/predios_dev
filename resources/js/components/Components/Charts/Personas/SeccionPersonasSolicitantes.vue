    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-2 gap-4 mb-4">
        <div class="border border-gray-300 rounded p-4 shadow">
            <BaseDonutChart
                ref="donutChart"
                apiUrl="/api/v1/tickets-distribucion-solicitante"
                chartTitle="Distribución de Tickets Solicitantes"
                v-bind="filters"
            />
        </div>
        ...
        <div class="border border-gray-300 rounded p-4 shadow">
            ...
            apiUrl="/api/v1/tickets-by-persona-solicitante"
            chartTitle="Tickets por persona"
            v-bind="filters"
            id="TicketsPersonaEstadoSolicitante"
            />
        </div>
      ...
      <div class="grid grid-cols-2 gap-4 mb-4">
        ...
        <div class="border border-gray-300 rounded p-4 shadow">
            <BaseHorizontalStackedBar
            ref="incidencias"
            apiUrl="/api/v1/incidencias-por-persona-solicitante"
            chartTitle="Incidencias Solicitantes y nivel de cumplimiento"
            v-bind="filters"
            id="IncidenciasPersonaSolicitante"
            />
        </div>
        ...
        <BaseHorizontalBar
          ref="rechazo"
          apiUrl="/api/v1/rechazo-por-persona-solicitante"
          chartTitle="Rechazo Solicitantes"
          v-bind="filters"
        />
      </div>
    </div>
      ...
      <!-- <div class="border border-gray-300 rounded p-4 shadow">
        <BaseHorizontalStackedBar
          ref="categoria"
          apiUrl="/api/v1/categoria-por-persona"
          chartTitle="Categoría por persona"
          v-bind="filters"
        />
      </div> -->
    </div>
  ...
  export default {
    ...
    methods: {
        ...
        async getPersonas(){
            ...
            try {
                const { data: { data } } = await axios.get(route('graficas.getPersonasByPredioSolicitante'), {
                    params: {
                        ...this.filters,
                    }
                });
